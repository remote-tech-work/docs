...
Agent'ınızı oluşturduktan sonra, aşağıdaki gelişmiş özellikleri kullanarak daha da özelleştirebilirsiniz:

### Yapılandırılmış Çıktılar

Agent'ınızın görüşme sonunda belirli bir formatta veri döndürmesini sağlayın:
- Randevu bilgilerini JSON formatında kaydetme
- Sipariş detaylarını otomatik çekme
- Anket sonuçlarını yapılandırılmış şekilde alma

### Ses ve Transkript Ayarları

Özel terimler ve telaffuz ayarları ile agent'ınızı optimize edin:
- Marka isimlerinin doğru yazılması (Key Terms)
- Kısaltmaların doğru telaffuz edilmesi (Voice Replacements)
- Sektöre özel terminoloji desteği

### Agent Araçları

Agent'ınıza özel yetenekler kazandırın:
- Katalog entegrasyonu ile ürün bilgisi sorgulama
- CRM'den müşteri bilgisi çekme
...
- Model seçimi (GPT-3.5 vs GPT-4)
- Temperature (yaratıcılık) ayarları
- Timeout ve davranış ayarları
